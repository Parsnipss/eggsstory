...
def lavaMonkey():
    ...
    weapon = input(Fore.GREEN + "Spoon" + Style.RESET_ALL +" or " + Fore.RED + "Fork?" + " " + Style.RESET_ALL)
...
def run():
    ...
    print("You slip and begin to enjoy the ride until the slide makes you miss the " + Fore.CYAN +  "Premium Grocery" + Style.RESET_ALL + " and you are separated from your precious " + Fore.YELLOW + "eggs." + Style.RESET_ALL)
    print(Fore.RED, Back.WHITE, Style.BRIGHT + "You Lose!" + Style.RESET_ALL)
    exit = input("Do you wish to exit the game? (" + Fore.GREEN + "Yes" + Style.RESET_ALL + " or " + Fore.RED + "No" + Style.RESET_ALL + "): ")
    if exit == "Yes" or exit == "yes":
        gameExit = True
